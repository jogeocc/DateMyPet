...
public class perfilMascotasAdapter extends BaseAdapter {
    protected Activity activity;
    protected List<Mascota> items;


    public perfilMascotasAdapter(Activity activity, List<Mascota> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = inf.inflate(R.layout.item_mascota_perfil, null);
